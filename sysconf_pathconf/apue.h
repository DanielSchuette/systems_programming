/*
 * Header file that is used before all standard C 
 * or Unix system headers in:
 * `Advanced Programming in the UNIX Environment'
 * by W. R. Stevens and S. A. Rago (Third Edition)
 */
#ifndef _APUE_H
#define _APUE_H
...
#include <sys/types.h>          /* might not be required */
#include <sys/stat.h>
...
/* 
 * the following includes are mostly for convenience 
 */
#include <stdio.h>
#include <stdlib.h>
...
/*
 * Prototypes for custom functions that are used
 * throughout the book's source code
 */
...
#define is_write_lockable(fd, offset, whence, len) \
    (lock_test((fd), F_SETLK, (offset), (whence), (len)) == 0)

/*
 * error and logging handlers as defined 
 * in error.c and log.c
 */
